import {
	...
	type FontFamily,
} from '~/components/builder/fonts/constants';
import { getAllFontFamiliesToLoad } from '~/components/builder/fonts/lib';
...
const Selection = ({
	...
	return (
		<button
			className='flex w-[105px] cursor-pointer items-center justify-center rounded-md border border-gray-300 py-2 shadow-sm hover:border-gray-400 hover:bg-gray-100'
			onClick={onClick}
